...
import com.smith.lotrdeckbuilder.export.JintekiNet;
import com.smith.lotrdeckbuilder.export.PlainText;
import com.smith.lotrdeckbuilder.fragments.DeckBuildFragment;
import com.smith.lotrdeckbuilder.fragments.DeckCardsFragment;
import com.smith.lotrdeckbuilder.fragments.DeckHandFragment;
import com.smith.lotrdeckbuilder.fragments.DeckInfoFragment;
import com.smith.lotrdeckbuilder.fragments.DeckMyCardsFragment;
...
import com.smith.lotrdeckbuilder.export.OCTGN;
import com.smith.lotrdeckbuilder.util.SlidingTabLayout;
...
public class DeckActivity extends ActionBarActivity implements OnDeckChangedListener {
    ...
    public static final String ARGUMENT_DECK_ID = "com.smith.lotrdeckbuilder.ARGUMENT_DECK_ID";
    public static final String ARGUMENT_SELECTED_TAB = "com.smith.lotrdeckbuilder.ARGUMENT_SELECTED_TAB";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.mnuOCTGN:
                ...
                intentEmail.putExtra(Intent.EXTRA_SUBJECT, "Lotr Deck - " + mDeck.getName());
            ...
            case R.id.mnuPlainText:
                ...
                intentEmailPlain.putExtra(Intent.EXTRA_SUBJECT, "Lotr Deck - " + mDeck.getName());
            ...
            case R.id.mnuJintekiNet:
                ...
                intentJintekiNetPlain.putExtra(Intent.EXTRA_SUBJECT, "Lotr Deck - " + mDeck.getName());
