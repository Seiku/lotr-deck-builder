...
import com.smith.lotrdeckbuilder.adapters.IdentitySpinnerAdapter;
import com.smith.lotrdeckbuilder.fragments.NewDeckChooseIdentityFragment;
...
public class ChooseIdentityActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_SIDE_CODE = "com.example.lotrdeckbuilder.EXTRA_SIDE_CODE";
    public static final String EXTRA_INITIAL_IDENTITY_CODE = "com.example.lotrdeckbuilder.EXTRA_INITIAL_IDENTITY_CODE";

    public static final String EXTRA_IDENTITY_CODE = "com.example.lotrdeckbuilder.EXTRA_IDENTITY_CODE";
